...
export default function BranchAdminDashboard() {
  ...
  return (
    <Screen loading={loading} scroll>
      <Card>
        <Text style={styles.welcome}>Branch administration</Text>
        <Text style={styles.hint}>
          Full operational control for your campus — classes, teachers, analytics, and branch settings.
        </Text>
      </Card>
      ...
      <Pressable onPress={() => router.push('/(branch-admin)/classes')}>
        <Card style={styles.action}>
          <Text style={styles.actionTitle}>Manage classes</Text>
          <Text style={styles.actionDesc}>Create, update, or delete sections</Text>
        </Card>
      </Pressable>
      <Pressable onPress={() => router.push('/(branch-admin)/teachers')}>
        <Card style={styles.action}>
          <Text style={styles.actionTitle}>Manage teachers</Text>
          <Text style={styles.actionDesc}>Onboard staff and assign classes</Text>
        </Card>
      </Pressable>
      <Pressable onPress={() => router.push('/(branch-admin)/branch')}>
        <Card style={styles.action}>
          <Text style={styles.actionTitle}>Branch settings</Text>
          <Text style={styles.actionDesc}>Terms, academic year, notes</Text>
        </Card>
      </Pressable>
    </Screen>
  );
...
const styles = StyleSheet.create({
  ...
  action: { borderLeftWidth: 4, borderLeftColor: AppTheme.branchAdmin },
